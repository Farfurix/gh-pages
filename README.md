...
### Основные страницы:
- **Главная** (`/`) — аналитический дашборд госзакупок
- **Презентация** (`/presentation`) — презентация проекта
- **Форум Россия-Китай** (`/forum`) — главная страница форума
- **Приглашение** (`/invitation`) — официальное приглашение на форум
